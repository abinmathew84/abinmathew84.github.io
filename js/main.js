...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Initialize EmailJS
    emailjs.init("8j0tJqttR-N81Cmzt");
...
function renderEducation() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            emailjs.send('service_619vaxp', 'template_isrosda', templateParams)
                .then(function(response) {
                    console.log('Email sent successfully!', response);
                    
                    // Show success message
                    emailStatus.textContent = 'Thank you for your message! I will get back to you soon.';
                    emailStatus.className = 'mt-4 text-center text-green-600 dark:text-green-400';
                ...
                .catch(function(error) {
                    ...
                    // Show error message
                    emailStatus.textContent = 'Sorry, there was an error sending your message. Please try again later.';
                    emailStatus.className = 'mt-4 text-center text-red-600 dark:text-red-400';
                })
                .finally(function() {
