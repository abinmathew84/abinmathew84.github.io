...
window.skillsData = {
    categories: [
        ...
        },
        {
            ...
            skills: ["Function Apps, Web Apps, Logic Apps", "Storage Account, CosmosDB, Blob", "Service Bus, Key Vault, Azure AD", "Azure VM, App Service, Resource Groups"]
        },
        {
            id: "databases",
            title: "Databases",
        ...
        },
        {
            ...
            skills: ["OpenAI (GPT), Anthropic (Claude)", "Google (Gemini), Ollama (Local)", "RAG, Vector Databases, MCP", "Generative AI, Agentic AI"]
        },
        {
            id: "scripting-tools",
...
window.aboutData = {
    ...
    image: "./images/Me.jpg" // Profile image
};
